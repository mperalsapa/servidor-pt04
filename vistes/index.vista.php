			...
			<div class="btn-group dropstart">
				<button type="button" class="btn btn-secondary rounded-circle " data-bs-toggle="dropdown" aria-expanded="false">
					...
					if (checkLogin()) {
						...
						echo "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-person p-0 m-0 mx-2\" viewBox=\"0 0 16 16\">
				...
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" href="iniciar-sessio.php">Iniciar Sessió</a></li>
					<li><a class="dropdown-item" href="registre.php">Registrarse</a></li>
				</ul>
			</div>
		</div>
